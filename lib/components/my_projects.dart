    ...
    return Column(
      ...
      children: [
        ...
        GridView.builder(
          ...
          scrollDirection: Axis.vertical,
          physics: const NeverScrollableScrollPhysics(),
          itemCount: workedProject.length,
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              childAspectRatio: Responsive.isDesktop(context)
                  ? 1
                  : Responsive.isMobile(context)
...
class MyProjectContainer extends StatelessWidget {
  final int i;

  const MyProjectContainer({super.key, required this.i});
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: AssetImage(myProjects[i].image),
                          fit: BoxFit.cover),
                    ),
                  ),
                  Padding(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          MiniButtonWidget(
                            ...
                            title: 'play',
                            action: () {
                              if (myProjects[i].playUrl.isNotEmpty) {
...
class WorkedProjectContainer extends StatelessWidget {
  ...
  const WorkedProjectContainer({super.key, required this.i});
  Future<void> launchUrlFun(Uri url) async {
    if (await canLaunchUrl(url)) {
      launchUrl(url, mode: LaunchMode.externalApplication);
    } else {
